...
public abstract class EthereumNetworkBase { // implements EthereumNetworkRepositoryType
    ...
    public static final int LUCKY_MAINNET_ID = 998;

    public static final String LUCKY_NETWORK_MAINNET_RPC_URL = "https://rpc.lnscan.org";
    ...
    static Map<Integer, NetworkInfo> networkMap = new LinkedHashMap<Integer, NetworkInfo>() {
        {
            put(LUCKY_MAINNET_ID, new NetworkInfo("Lucky Network", "L99", LUCKY_NETWORK_MAINNET_RPC_URL, "https://explorer.luckynetwork.org/tx/",
                    LUCKY_MAINNET_ID));
