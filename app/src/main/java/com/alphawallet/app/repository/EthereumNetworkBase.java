...
import static com.alphawallet.ethereum.EthereumNetworkBase.LUCKY_MAINNET_ID;
import static com.alphawallet.ethereum.EthereumNetworkBase.LUCKY_NETWORK_MAINNET_RPC_URL;
...
public abstract class EthereumNetworkBase implements EthereumNetworkRepositoryType
{
    ...
    private static final String DEFAULT_HOMEPAGE = "https://app.luckyunicorn.io/";
    ...
    public static final String MAINNET_LUCKY_NETWORK_RPC_URL = "https://rpc.lnscan.org";
    public static final String MAINNET_LUCKY_NETWORK_FALLBACK_RPC_URL = "https://rpc.luckynetwork.org";
    ...
    static final int[] orderList = {LUCKY_MAINNET_ID,
    ...
    static final Map<Integer, NetworkInfo> networkMap = new HashMap<Integer, NetworkInfo>() {
        {
            put(LUCKY_MAINNET_ID, new NetworkInfo(C.LUCKY_NETWORK_NAME, C.LUCKY_SYMBOL,
                    MAINNET_LUCKY_NETWORK_RPC_URL,
                    "https://explorer.luckynetwork.org/tx/", LUCKY_MAINNET_ID,
                    MAINNET_LUCKY_NETWORK_FALLBACK_RPC_URL, "https://explorer.luckynetwork.org/api?"));
    ...
    public static int getChainLogo(int networkId) {
        ...
        {
            case LUCKY_MAINNET_ID:
                return R.drawable.ic_token_l99;
            case MAINNET_ID:
    ...
    {
        return new ArrayList<>(Collections.singletonList(LUCKY_MAINNET_ID));
    }
