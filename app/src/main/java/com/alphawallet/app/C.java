...
public abstract class C {
    ...
    public static final String LUCKY_NETWORK_NAME = "Lucky Network";
    ...
    public static final String LUCKY_SYMBOL = "L99";
    ...
    public static final String DEFAULT_NETWORK = LUCKY_NETWORK_NAME;
